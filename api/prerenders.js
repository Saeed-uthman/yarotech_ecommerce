aimport puppeteer from "puppeteer";
...
async function getProductSlugs() {
  ...
  try {
    const res = await fetch(
      "https://api-shop.yarotech.com.ng/yarotech-api/public/api/products?per_page=1000"
    );
...
async function generateSitemap() {
  try {
    ...
    const res = await fetch(
      "https://api-shop.yarotech.com.ng/yarotech-api/public/api/sitemap.xml"
    );
